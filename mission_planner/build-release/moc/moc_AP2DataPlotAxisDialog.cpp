...
void AP2DataPlotAxisDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AP2DataPlotAxisDialog::graphAddedToGroup)) {
                *result = 0;
            }
        }
        {
            typedef void (AP2DataPlotAxisDialog::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AP2DataPlotAxisDialog::graphRemovedFromGroup)) {
                *result = 1;
            }
        }
        {
            typedef void (AP2DataPlotAxisDialog::*_t)(QString , double , double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AP2DataPlotAxisDialog::graphManualRange)) {
                *result = 2;
            }
        }
        {
            typedef void (AP2DataPlotAxisDialog::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AP2DataPlotAxisDialog::graphAutoRange)) {
                *result = 3;
            }
        }
        {
            typedef void (AP2DataPlotAxisDialog::*_t)(QList<AP2DataPlotAxisDialog::GraphRange> );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AP2DataPlotAxisDialog::graphGroupingChanged)) {
                *result = 4;
            }
        }
        {
            typedef void (AP2DataPlotAxisDialog::*_t)(QMap<QString,QColor> );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AP2DataPlotAxisDialog::graphColorsChanged)) {
                *result = 5;
            }
        }
    }
...
const QMetaObject AP2DataPlotAxisDialog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AP2DataPlotAxisDialog.data,
      qt_meta_data_AP2DataPlotAxisDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AP2DataPlotAxisDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AP2DataPlotAxisDialog.stringdata0))
        return static_cast<void*>(const_cast< AP2DataPlotAxisDialog*>(this));
