...
void LogConsole::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LogConsole::statusMessage)) {
                *result = 0;
            }
        }
        {
            typedef void (LogConsole::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LogConsole::activityStart)) {
                *result = 1;
            }
        }
        {
            typedef void (LogConsole::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LogConsole::activityStop)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject LogConsole::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LogConsole.data,
      qt_meta_data_LogConsole,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LogConsole::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LogConsole.stringdata0))
        return static_cast<void*>(const_cast< LogConsole*>(this));
...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Worker::startFile)) {
                *result = 0;
            }
        }
        {
            typedef void (Worker::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Worker::finishFile)) {
                *result = 1;
            }
        }
        {
            typedef void (Worker::*_t)(long );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Worker::bytesRead)) {
                *result = 2;
            }
        }
        {
            typedef void (Worker::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Worker::statusMsg)) {
                *result = 3;
            }
        }
        {
            typedef void (Worker::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Worker::finishAll)) {
                *result = 4;
            }
        }
        {
        ...
        {
            typedef void (Worker::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Worker::cancelled)) {
                *result = 6;
            }
        }
    }
