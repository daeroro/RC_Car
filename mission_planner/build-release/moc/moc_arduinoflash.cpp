...
void ArduinoFlash::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ArduinoFlash::flashProgress)) {
                *result = 0;
            }
        }
        {
            typedef void (ArduinoFlash::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ArduinoFlash::flashComplete)) {
                *result = 1;
            }
        }
        {
            typedef void (ArduinoFlash::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ArduinoFlash::flashFailed)) {
                *result = 2;
            }
        }
        {
            typedef void (ArduinoFlash::*_t)(qint64 , qint64 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ArduinoFlash::verifyProgress)) {
                *result = 3;
            }
        }
        {
            typedef void (ArduinoFlash::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ArduinoFlash::verifyComplete)) {
                *result = 4;
            }
        }
        {
            typedef void (ArduinoFlash::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ArduinoFlash::verifyFailed)) {
                *result = 5;
            }
        }
        {
            typedef void (ArduinoFlash::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ArduinoFlash::firmwareUploadError)) {
                *result = 6;
            }
        }
        {
            typedef void (ArduinoFlash::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ArduinoFlash::firmwareUploadStarted)) {
                *result = 7;
            }
        }
        {
            typedef void (ArduinoFlash::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ArduinoFlash::firmwareUploadComplete)) {
                *result = 8;
            }
        }
        {
            typedef void (ArduinoFlash::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ArduinoFlash::statusUpdate)) {
                *result = 9;
            }
        }
        {
            typedef void (ArduinoFlash::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ArduinoFlash::debugUpdate)) {
                *result = 10;
            }
        }
    }
...
const QMetaObject ArduinoFlash::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ArduinoFlash.data,
      qt_meta_data_ArduinoFlash,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ArduinoFlash::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ArduinoFlash.stringdata0))
        return static_cast<void*>(const_cast< ArduinoFlash*>(this));
