...
void LinkManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LinkManager::protocolStatusMessage)) {
                *result = 1;
            }
        }
        {
            typedef void (LinkManager::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LinkManager::linkChanged)) {
                *result = 2;
            }
        }
        {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LinkManager::linkError)) {
                *result = 4;
            }
        }
        {
            typedef void (LinkManager::*_t)(LinkInterface * , mavlink_message_t );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LinkManager::messageReceived)) {
                *result = 5;
            }
        }
    }
