...
void UASManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UASManager::UASCreated)) {
                *result = 0;
            }
        }
        {
            typedef void (UASManager::*_t)(UASInterface * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UASManager::UASDeleted)) {
                *result = 1;
            }
        }
        {
            typedef void (UASManager::*_t)(UASInterface * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UASManager::activeUASSet)) {
                *result = 2;
            }
        }
        {
        ...
        {
            typedef void (UASManager::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UASManager::activeUASSetListIndex)) {
                *result = 4;
            }
        }
        {
            typedef void (UASManager::*_t)(UASInterface * , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UASManager::activeUASStatusChanged)) {
                *result = 5;
            }
        }
        {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UASManager::homePositionChanged)) {
                *result = 7;
            }
        }
    }
