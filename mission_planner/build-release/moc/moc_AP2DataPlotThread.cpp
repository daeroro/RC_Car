...
void AP2DataPlotThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AP2DataPlotThread::startLoad)) {
                *result = 0;
            }
        }
        {
            typedef void (AP2DataPlotThread::*_t)(qint64 , qint64 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AP2DataPlotThread::loadProgress)) {
                *result = 1;
            }
        }
        {
            typedef void (AP2DataPlotThread::*_t)(AP2DataPlotStatus );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AP2DataPlotThread::done)) {
                *result = 2;
            }
        }
        {
            typedef void (AP2DataPlotThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AP2DataPlotThread::error)) {
                *result = 3;
            }
        }
    }
...
const QMetaObject AP2DataPlotThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_AP2DataPlotThread.data,
      qt_meta_data_AP2DataPlotThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AP2DataPlotThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AP2DataPlotThread.stringdata0))
        return static_cast<void*>(const_cast< AP2DataPlotThread*>(this));
    if (!strcmp(_clname, "IParserCallback"))
        return static_cast< IParserCallback*>(const_cast< AP2DataPlotThread*>(this));
