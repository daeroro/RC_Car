...
void RelPositionOverview::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RelPositionOverview::airspeedChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (RelPositionOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RelPositionOverview::groundspeedChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (RelPositionOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RelPositionOverview::altChanged)) {
                *result = 2;
            }
        }
        {
            typedef void (RelPositionOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RelPositionOverview::climbChanged)) {
                *result = 3;
            }
        }
        {
            typedef void (RelPositionOverview::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RelPositionOverview::headingChanged)) {
                *result = 4;
            }
        }
        {
            typedef void (RelPositionOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RelPositionOverview::throttleChanged)) {
                *result = 5;
            }
        }
        {
            typedef void (RelPositionOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RelPositionOverview::timeBootMsChanged)) {
                *result = 6;
            }
        }
        {
            typedef void (RelPositionOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RelPositionOverview::rollChanged)) {
                *result = 7;
            }
        }
        {
            typedef void (RelPositionOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RelPositionOverview::pitchChanged)) {
                *result = 8;
            }
        }
        {
            typedef void (RelPositionOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RelPositionOverview::yawChanged)) {
                *result = 9;
            }
        }
        {
            typedef void (RelPositionOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RelPositionOverview::rollspeedChanged)) {
                *result = 10;
            }
        }
        {
            typedef void (RelPositionOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RelPositionOverview::pitchspeedChanged)) {
                *result = 11;
            }
        }
        {
            typedef void (RelPositionOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RelPositionOverview::yawspeedChanged)) {
                *result = 12;
            }
        }
    }
...
const QMetaObject RelPositionOverview::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_RelPositionOverview.data,
      qt_meta_data_RelPositionOverview,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RelPositionOverview::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RelPositionOverview.stringdata0))
        return static_cast<void*>(const_cast< RelPositionOverview*>(this));
