...
void QGCUASParamManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QGCUASParamManager::parameterChanged)) {
                *result = 0;
            }
        }
        {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QGCUASParamManager::parameterListUpToDate)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject QGCUASParamManager::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QGCUASParamManager.data,
      qt_meta_data_QGCUASParamManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
