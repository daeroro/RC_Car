...
void VehicleOverview::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::customModeChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::typeChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::autopilotChanged)) {
                *result = 2;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::baseModeChanged)) {
                *result = 3;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::systemStatusChanged)) {
                *result = 4;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::mavlinkVersionChanged)) {
                *result = 5;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::onboardControlSensorsPresentChanged)) {
                *result = 6;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::onboardControlSensorsEnabledChanged)) {
                *result = 7;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::onboardControlSensorsHealthChanged)) {
                *result = 8;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::loadChanged)) {
                *result = 9;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::voltageBatteryChanged)) {
                *result = 10;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::dropRateCommChanged)) {
                *result = 11;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::errorsCommChanged)) {
                *result = 12;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::errorsCount1Changed)) {
                *result = 13;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::errorsCount2Changed)) {
                *result = 14;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::errorsCount3Changed)) {
                *result = 15;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::errorsCount4Changed)) {
                *result = 16;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::navRollChanged)) {
                *result = 17;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::navPitchChanged)) {
                *result = 18;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::altErrorChanged)) {
                *result = 19;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::aspdErrorChanged)) {
                *result = 20;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::xtrackErrorChanged)) {
                *result = 21;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::navBearingChanged)) {
                *result = 22;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::targetBearingChanged)) {
                *result = 23;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::wpDistChanged)) {
                *result = 24;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::currentConsumedChanged)) {
                *result = 25;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::energyConsumedChanged)) {
                *result = 26;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::voltageCell1Changed)) {
                *result = 27;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::voltageCell2Changed)) {
                *result = 28;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::voltageCell3Changed)) {
                *result = 29;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::voltageCell4Changed)) {
                *result = 30;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::voltageCell5Changed)) {
                *result = 31;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::voltageCell6Changed)) {
                *result = 32;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::currentBatteryChanged)) {
                *result = 33;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::accuIdChanged)) {
                *result = 34;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::batteryRemainingChanged)) {
                *result = 35;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::VccChanged)) {
                *result = 36;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::VservoChanged)) {
                *result = 37;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::flagsChanged)) {
                *result = 38;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::rxerrorsChanged)) {
                *result = 39;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::fixedChanged)) {
                *result = 40;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::rssiChanged)) {
                *result = 41;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::remrssiChanged)) {
                *result = 42;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::txbufChanged)) {
                *result = 43;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::noiseChanged)) {
                *result = 44;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::remnoiseChanged)) {
                *result = 45;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::armedStateChanged)) {
                *result = 46;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::vibrationXChanged)) {
                *result = 47;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::vibrationYChanged)) {
                *result = 48;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::vibrationZChanged)) {
                *result = 49;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::clipping0Changed)) {
                *result = 50;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::clipping1Changed)) {
                *result = 51;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::clipping2Changed)) {
                *result = 52;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(unsigned int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::ekfFlagsChanged)) {
                *result = 53;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(float );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::ekfVelocityVarianceChanged)) {
                *result = 54;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(float );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::ekfPosHorizVarianceChanged)) {
                *result = 55;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(float );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::ekfPosVertVarianceChanged)) {
                *result = 56;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(float );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::ekfCompassVarianceChanged)) {
                *result = 57;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(float );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::ekfTerrainAltVarianceChanged)) {
                *result = 58;
            }
        }
        {
            typedef void (VehicleOverview::*_t)(const int , const QString & , const QString & , const QVariant & , const quint64 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VehicleOverview::valueChanged)) {
                *result = 59;
            }
        }
    }
...
const QMetaObject VehicleOverview::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VehicleOverview.data,
      qt_meta_data_VehicleOverview,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VehicleOverview::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VehicleOverview.stringdata0))
        return static_cast<void*>(const_cast< VehicleOverview*>(this));
