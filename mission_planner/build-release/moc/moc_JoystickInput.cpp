...
void JoystickInput::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&JoystickInput::joystickSelected)) {
                *result = 0;
            }
        }
        {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&JoystickInput::thrustChanged)) {
                *result = 2;
            }
        }
        {
            typedef void (JoystickInput::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&JoystickInput::xChanged)) {
                *result = 3;
            }
        }
        {
            typedef void (JoystickInput::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&JoystickInput::yChanged)) {
                *result = 4;
            }
        }
        {
            typedef void (JoystickInput::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&JoystickInput::yawChanged)) {
                *result = 5;
            }
        }
        {
