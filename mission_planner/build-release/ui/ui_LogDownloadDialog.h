...
public:
    ...
    {
        LogDownloadDialog->setWindowTitle(QApplication::translate("LogDownloadDialog", "Log Download", 0));
        donePushButton->setText(QApplication::translate("LogDownloadDialog", "Done", 0));
        refreshPushButton->setText(QApplication::translate("LogDownloadDialog", "Refresh", 0));
        getPushButton->setText(QApplication::translate("LogDownloadDialog", "Download Log(s)", 0));
        erasePushButton->setText(QApplication::translate("LogDownloadDialog", "Erase Logs", 0));
        cancelPushButton->setText(QApplication::translate("LogDownloadDialog", "Cancel", 0));
        checkAllBox->setText(QApplication::translate("LogDownloadDialog", "Check/Uncheck All", 0));
