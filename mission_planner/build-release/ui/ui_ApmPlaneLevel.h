...
public:
    ...
    {
        ApmPlaneLevel->setWindowTitle(QApplication::translate("ApmPlaneLevel", "Form", 0));
        label->setText(QApplication::translate("ApmPlaneLevel", "<h2>ArduPlane Level</h2>", 0));
...
"level and perform a level to calibrate the accel offsets.", 0));
        label_3->setText(QApplication::translate("ApmPlaneLevel", "Level your plane and click Level to set default accel offsets", 0));
        levelPushButton->setText(QApplication::translate("ApmPlaneLevel", "Level", 0));
        groupBox->setTitle(QApplication::translate("ApmPlaneLevel", "For advanced users ONLY", 0));
        manualLevelCheckBox->setText(QApplication::translate("ApmPlaneLevel", "Manual Level", 0));
    } // retranslateUi
