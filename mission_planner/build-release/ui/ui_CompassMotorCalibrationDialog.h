...
public:
    ...
    {
        CompassMotorCalibrationDialog->setWindowTitle(QApplication::translate("CompassMotorCalibrationDialog", "Compass Motor Interference Config", 0));
        label->setText(QApplication::translate("CompassMotorCalibrationDialog", "Messages", 0));
        okButton->setText(QApplication::translate("CompassMotorCalibrationDialog", "OK", 0));
        startButton->setText(QApplication::translate("CompassMotorCalibrationDialog", "Start", 0));
        stopButton->setText(QApplication::translate("CompassMotorCalibrationDialog", "Stop", 0));
    } // retranslateUi
