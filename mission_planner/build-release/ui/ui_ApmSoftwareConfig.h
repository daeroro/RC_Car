...
public:
    ...
    {
        ApmSoftwareConfig->setWindowTitle(QApplication::translate("ApmSoftwareConfig", "Form", 0));
        flightModesButton->setText(QApplication::translate("ApmSoftwareConfig", "Flight Modes", 0));
        geoFenceButton->setText(QApplication::translate("ApmSoftwareConfig", "Geo Fence", 0));
        basicPidButton->setText(QApplication::translate("ApmSoftwareConfig", "Basic Tuning", 0));
        arduCopterPidButton->setText(QApplication::translate("ApmSoftwareConfig", "APM:Copter PIDs", 0));
        arduPlanePidButton->setText(QApplication::translate("ApmSoftwareConfig", "APM:Plane PIDs", 0));
        arduRoverPidButton->setText(QApplication::translate("ApmSoftwareConfig", "APM:Rover PIDs", 0));
        standardParamButton->setText(QApplication::translate("ApmSoftwareConfig", "Standard Params", 0));
        advancedParamButton->setText(QApplication::translate("ApmSoftwareConfig", "Advanced Params", 0));
        advParamListButton->setText(QApplication::translate("ApmSoftwareConfig", "Full Parameter List", 0));
        plannerConfigButton->setText(QApplication::translate("ApmSoftwareConfig", "APM Planner 2.0 Config", 0));
        globalParamStateLabel->setText(QApplication::translate("ApmSoftwareConfig", "Parameters", 0));
        globalParamProgressLabel->setText(QApplication::translate("ApmSoftwareConfig", "0/?", 0));
    } // retranslateUi
