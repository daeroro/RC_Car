...
#ifndef QT_NO_TOOLTIP
        portName->setToolTip(QApplication::translate("serialSettings", "The serial port to which the system is connected. All ports listed here should work.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        portName->setStatusTip(QApplication::translate("serialSettings", "The serial port to which the system is connected. All ports listed here should work.", 0));
#endif // QT_NO_STATUSTIP
#ifndef QT_NO_WHATSTHIS
        portName->setWhatsThis(QApplication::translate("serialSettings", "The serial port to which the system is connected. All ports listed here should work.", 0));
#endif // QT_NO_WHATSTHIS
