...
public:
    ...
    void retranslateUi(QWidget *MapRipForm)
    {
        ...
        lblProvider->setText(QApplication::translate("MapRipForm", "Currently ripping from:", 0));
        lblLevel->setText(QApplication::translate("MapRipForm", "Zoom level:", 0));
        statuslabel->setText(QApplication::translate("MapRipForm", "Downloading tile:", 0));
        rdoBtn_singleLayer->setText(QApplication::translate("MapRipForm", "Single Layer Cache -- Current Level		", 0));
        rdoBtn_multiLlayer->setText(QApplication::translate("MapRipForm", "Auto Muli-Layer Cache -- Current Level -> Stopping Level: ", 0));
        label_2->setText(QApplication::translate("MapRipForm", "(Default 19)", 0));
        pshBtnBeginRip->setText(QApplication::translate("MapRipForm", "Begin", 0));
