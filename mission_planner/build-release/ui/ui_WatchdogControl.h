...
public:
    ...
    {
        WatchdogControl->setWindowTitle(QApplication::translate("WatchdogControl", "Form", 0));
        processInfoLabel->setText(QApplication::translate("WatchdogControl", "0 Processes  Core 1: 0%  Core 2: 0%", 0));
    } // retranslateUi
