...
public:
    ...
    {
        StandardParamConfig->setWindowTitle(QApplication::translate("StandardParamConfig", "Form", 0));
        label->setText(QApplication::translate("StandardParamConfig", "<h2>Standard Params</h2>", 0));
#ifndef QT_NO_TOOLTIP
        searchFilter->setToolTip(QApplication::translate("StandardParamConfig", "Type words separated by spaces. Only parameters which match all search terms will be displayed.", 0));
#endif // QT_NO_TOOLTIP
        searchFilter->setPlaceholderText(QApplication::translate("StandardParamConfig", "Filter", 0));
    } // retranslateUi
