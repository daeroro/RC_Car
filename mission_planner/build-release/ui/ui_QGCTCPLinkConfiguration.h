...
public:
    ...
    void retranslateUi(QWidget *QGCTCPLinkConfiguration)
    {
        ...
        hostLabel->setText(QApplication::translate("QGCTCPLinkConfiguration", "Host Address", 0));
        portLabel->setText(QApplication::translate("QGCTCPLinkConfiguration", "TCP Port", 0));
        asServerCheckBox->setText(QApplication::translate("QGCTCPLinkConfiguration", "As Server?", 0));
        statusLabel->setText(QApplication::translate("QGCTCPLinkConfiguration", "...", 0));
    } // retranslateUi
