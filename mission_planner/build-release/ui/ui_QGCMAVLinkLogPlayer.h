...
public:
    ...
    void retranslateUi(QWidget *QGCMAVLinkLogPlayer)
    {
        ...
        logStatsLabel->setText(QApplication::translate("QGCMAVLinkLogPlayer", "No logfile selected..", 0));
        logFileNameLabel->setText(QApplication::translate("QGCMAVLinkLogPlayer", "-", 0));
#ifndef QT_NO_TOOLTIP
        playButton->setToolTip(QApplication::translate("QGCMAVLinkLogPlayer", "Start to replay the logfile", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        playButton->setStatusTip(QApplication::translate("QGCMAVLinkLogPlayer", "Start to replay the logfile", 0));
#endif // QT_NO_STATUSTIP
#ifndef QT_NO_WHATSTHIS
        playButton->setWhatsThis(QApplication::translate("QGCMAVLinkLogPlayer", "Start to replay the logfile", 0));
#endif // QT_NO_WHATSTHIS
        playButton->setText(QApplication::translate("QGCMAVLinkLogPlayer", "...", 0));
        label->setText(QApplication::translate("QGCMAVLinkLogPlayer", "Position:", 0));
        positionLabel->setText(QString());
#ifndef QT_NO_TOOLTIP
        speedTitleLabel->setToolTip(QApplication::translate("QGCMAVLinkLogPlayer", "Current replay speed", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        speedTitleLabel->setStatusTip(QApplication::translate("QGCMAVLinkLogPlayer", "Current replay speed", 0));
#endif // QT_NO_STATUSTIP
#ifndef QT_NO_WHATSTHIS
        speedTitleLabel->setWhatsThis(QApplication::translate("QGCMAVLinkLogPlayer", "Current replay speed", 0));
#endif // QT_NO_WHATSTHIS
        speedTitleLabel->setText(QApplication::translate("QGCMAVLinkLogPlayer", "Speed", 0));
        speedButton75->setText(QApplication::translate("QGCMAVLinkLogPlayer", "0.75X", 0));
        speedButton100->setText(QApplication::translate("QGCMAVLinkLogPlayer", "1x", 0));
        speedButton150->setText(QApplication::translate("QGCMAVLinkLogPlayer", "1.5X", 0));
        speedButton200->setText(QApplication::translate("QGCMAVLinkLogPlayer", "2X", 0));
        speedButton500->setText(QApplication::translate("QGCMAVLinkLogPlayer", "5X", 0));
        speedButton1000->setText(QApplication::translate("QGCMAVLinkLogPlayer", "10X", 0));
#ifndef QT_NO_TOOLTIP
        selectFileButton->setToolTip(QApplication::translate("QGCMAVLinkLogPlayer", "Select the logfile to replay", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        selectFileButton->setStatusTip(QApplication::translate("QGCMAVLinkLogPlayer", "Select the logfile to replay", 0));
#endif // QT_NO_STATUSTIP
#ifndef QT_NO_WHATSTHIS
        selectFileButton->setWhatsThis(QApplication::translate("QGCMAVLinkLogPlayer", "Select the logfile to replay", 0));
#endif // QT_NO_WHATSTHIS
        selectFileButton->setText(QApplication::translate("QGCMAVLinkLogPlayer", "Replay Logfile", 0));
    } // retranslateUi
