...
public:
    ...
    {
        AirspeedConfig->setWindowTitle(QApplication::translate("AirspeedConfig", "Form", 0));
        label->setText(QApplication::translate("AirspeedConfig", "<h2>Airspeed</h2>", 0));
        label_2->setText(QString());
        enableCheckBox->setText(QApplication::translate("AirspeedConfig", "Enable", 0));
        useAirspeedCheckBox->setText(QApplication::translate("AirspeedConfig", "Use Airspeed", 0));
        label_3->setText(QApplication::translate("AirspeedConfig", "Pin Number", 0));
        pinHelperGroupBox->setTitle(QApplication::translate("AirspeedConfig", "Pin Selection Helper", 0));
        hardwareGroupBox->setTitle(QApplication::translate("AirspeedConfig", "Choose Hardware", 0));
        hardwareComboBox->clear();
        hardwareComboBox->insertItems(0, QStringList()
         << QApplication::translate("AirspeedConfig", "Choose One", 0)
         << QApplication::translate("AirspeedConfig", "APM1.X", 0)
         << QApplication::translate("AirspeedConfig", "APM2.X", 0)
         << QApplication::translate("AirspeedConfig", "PX4", 0)
         << QApplication::translate("AirspeedConfig", "Pixhawk", 0)
        );
        sensorGroupBox->setTitle(QApplication::translate("AirspeedConfig", "Choose Sensor", 0));
        pinGroupBox->setTitle(QApplication::translate("AirspeedConfig", "Choose Pin", 0));
    } // retranslateUi
