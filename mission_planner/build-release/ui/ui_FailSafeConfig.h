...
public:
    ...
    {
        FailSafeConfig->setWindowTitle(QApplication::translate("FailSafeConfig", "Form", 0));
        label->setText(QApplication::translate("FailSafeConfig", "<h2>Fail Safe</h2>", 0));
        groupBox->setTitle(QApplication::translate("FailSafeConfig", "Status", 0));
        modeLabel->setText(QApplication::translate("FailSafeConfig", "TextLabel", 0));
        armedLabel->setText(QApplication::translate("FailSafeConfig", "TextLabel", 0));
        gpsLabel->setText(QApplication::translate("FailSafeConfig", "TextLabel", 0));
        label_2->setText(QApplication::translate("FailSafeConfig", "Radio IN", 0));
        label_3->setText(QApplication::translate("FailSafeConfig", "Servo/Motor OUT", 0));
        groupBox_3->setTitle(QApplication::translate("FailSafeConfig", "Throttle Failsafe", 0));
        throttleCheckBox->setText(QApplication::translate("FailSafeConfig", "Throttle FailSafe", 0));
        label_5->setText(QApplication::translate("FailSafeConfig", "Throttle PWM", 0));
        throttleActionCheckBox->setText(QApplication::translate("FailSafeConfig", "Throttle FailSafe Action", 0));
        gcsCheckBox->setText(QApplication::translate("FailSafeConfig", "GCS FailSafe", 0));
        fsShortCheckBox->setText(QApplication::translate("FailSafeConfig", "FailSafe Short (1 sec)", 0));
        fsLongCheckBox->setText(QApplication::translate("FailSafeConfig", "FailSafe Long (20 sec)", 0));
        groupBox_4->setTitle(QApplication::translate("FailSafeConfig", "Battery Failsafe", 0));
        label_6->setText(QApplication::translate("FailSafeConfig", "Low Battery (V)", 0));
        label_7->setText(QApplication::translate("FailSafeConfig", "Low Battery (mAh)", 0));
    } // retranslateUi
