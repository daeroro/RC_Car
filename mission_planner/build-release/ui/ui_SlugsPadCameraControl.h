...
public:
    ...
    {
        SlugsPadCameraControl->setWindowTitle(QApplication::translate("SlugsPadCameraControl", "Form", 0));
        lbPixel->setText(QApplication::translate("SlugsPadCameraControl", "----", 0));
        lbDirection->setText(QApplication::translate("SlugsPadCameraControl", "----", 0));
    } // retranslateUi
