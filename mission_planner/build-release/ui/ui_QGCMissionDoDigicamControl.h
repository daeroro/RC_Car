...
public:
    ...
    {
        QGCMissionDoDigicamControl->setWindowTitle(QApplication::translate("QGCMissionDoDigicamControl", "Form", 0));
        param1SpinBox->setPrefix(QApplication::translate("QGCMissionDoDigicamControl", "off/on ", 0));
        param1SpinBox->setSuffix(QString());
        param4SpinBox->setPrefix(QApplication::translate("QGCMissionDoDigicamControl", "Focus Lock ", 0));
        param5SpinBox->setPrefix(QApplication::translate("QGCMissionDoDigicamControl", " Shutter ", 0));
    } // retranslateUi
