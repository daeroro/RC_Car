...
public:
    ...
    {
        ApmFirmwareConfig->setWindowTitle(QApplication::translate("ApmFirmwareConfig", "Form", 0));
        label->setText(QApplication::translate("ApmFirmwareConfig", "<h2>Firmware</h2>", 0));
        warningLabel->setText(QApplication::translate("ApmFirmwareConfig", "<html><head/><body><p><span style=\" font-size:large; font-weight:600; color:#e90000;\">WARNING:</span><span style=\" font-size:large; font-weight:600; color:#cf8a00;\"> Only install BETA firmware if you are an experienced tester.</span></p></body></html>", 0));
        warningLabelAC33->setText(QApplication::translate("ApmFirmwareConfig", "<html><head/><body><p><span style=\" font-size:large; font-weight:600; color:#e90000;\">WARNING:</span><span style=\" font-size:large; font-weight:600; color:#cf8a00;\"> ArduCopter 3.3 is not available for APM1/APM2. The last available version is shown here </span></p></body></html>", 0));
...
"</table></body></html>", 0));
        ...
        y6Label->setText(QApplication::translate("ApmFirmwareConfig", "ArduCopter vX.XX", 0));
        planeLabel->setText(QApplication::translate("ApmFirmwareConfig", "ArduPlane vX.XX", 0));
        planePushButton->setText(QString());
        octaPushButton->setText(QString());
        octaLabel->setText(QApplication::translate("ApmFirmwareConfig", "ArduCopter vX.XX", 0));
        quadLabel->setText(QApplication::translate("ApmFirmwareConfig", "ArduCopter vX.XX", 0));
        quadPushButton->setText(QString());
        octaQuadLabel->setText(QApplication::translate("ApmFirmwareConfig", "ArduCopter vX.XX", 0));
        octaQuadPushButton->setText(QString());
        triLabel->setText(QApplication::translate("ApmFirmwareConfig", "ArduCopter vX.XX", 0));
        triPushButton->setText(QString());
        hexaLabel->setText(QApplication::translate("ApmFirmwareConfig", "ArduCopter vX.XX", 0));
        hexaPushButton->setText(QString());
        copterLabel->setText(QApplication::translate("ApmFirmwareConfig", "ArduCopter vX.XX", 0));
        copterPushButton->setText(QString());
        roverLabel->setText(QApplication::translate("ApmFirmwareConfig", "ArduRover vX.XX", 0));
        roverPushButton->setText(QString());
        optionsLabel->setText(QApplication::translate("ApmFirmwareConfig", "Firmware Options", 0));
        betaFirmwareButton->setText(QApplication::translate("ApmFirmwareConfig", "Beta", 0));
        flashCustomFWButton->setText(QApplication::translate("ApmFirmwareConfig", "Custom ", 0));
        stableFirmwareButton->setText(QApplication::translate("ApmFirmwareConfig", "Stable", 0));
        rebootButton->setText(QApplication::translate("ApmFirmwareConfig", "Reboot ", 0));
        label_2->setText(QApplication::translate("ApmFirmwareConfig", "<h4>Firmware Upload<br>Com Port</h4>", 0));
        comPortNameLabel->setText(QString());
        cancelPushButton->setText(QApplication::translate("ApmFirmwareConfig", "Cancel", 0));
        statusLabel_2->setText(QApplication::translate("ApmFirmwareConfig", "Status:", 0));
        statusLabel->setText(QString());
        showOutputCheckBox->setText(QApplication::translate("ApmFirmwareConfig", "Show Output", 0));
        mutlicopterPushButton->setText(QString());
        multicopterLabel->setText(QApplication::translate("ApmFirmwareConfig", "ArduCopter vX.XX", 0));
        label_3->setText(QApplication::translate("ApmFirmwareConfig", "<html><head/><body><p><span style=\" font-size:12pt;\">You cannot load new firmware while connected via MAVLink.</span></p><p><br/></p><p><span style=\" font-size:12pt;\">Please press the Disconnect button at top right to end the current</span></p><p><span style=\" font-size:12pt;\">MAVLink session and enable firmware loading screen</span></p></body></html>", 0));
    } // retranslateUi
