...
public:
    ...
    {
        AutoUpdateDialog->setWindowTitle(QApplication::translate("AutoUpdateDialog", "Auto Update", 0));
        ap2Logo->setText(QApplication::translate("AutoUpdateDialog", "<html><head/><body><p><img src=\":/APMIcon128\"/></p></body></html>", 0));
        titleLabel->setText(QApplication::translate("AutoUpdateDialog", "<html><head/><body><p><span style=\" font-size:18pt; font-weight:600;\">New Version Available</span></p></body></html>", 0));
        versionLabel->setText(QApplication::translate("AutoUpdateDialog", "...", 0));
        questionLabel->setText(QApplication::translate("AutoUpdateDialog", "Do you want to install this version?", 0));
        statusLabel->setText(QApplication::translate("AutoUpdateDialog", "...", 0));
        skipPushButton->setText(QApplication::translate("AutoUpdateDialog", "Skip This Version", 0));
        noPushButton->setText(QApplication::translate("AutoUpdateDialog", "Remind Me Later", 0));
        yesPushButton->setText(QApplication::translate("AutoUpdateDialog", "Install", 0));
    } // retranslateUi
