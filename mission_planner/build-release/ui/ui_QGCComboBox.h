...
public:
    ...
    {
        QGCComboBox->setWindowTitle(QApplication::translate("QGCComboBox", "Form", 0));
        nameLabel->setText(QApplication::translate("QGCComboBox", "Name", 0));
        infoLabel->setText(QApplication::translate("QGCComboBox", "?", 0));
        editNameLabel->setText(QApplication::translate("QGCComboBox", "<Parameter Name / Label>", 0));
        itemNameLabel->setText(QApplication::translate("QGCComboBox", "Name", 0));
#ifndef QT_NO_TOOLTIP
        editSelectComponentComboBox->setToolTip(QApplication::translate("QGCComboBox", "Select component", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        editSelectComponentComboBox->setStatusTip(QApplication::translate("QGCComboBox", "Select component", 0));
#endif // QT_NO_STATUSTIP
        editAddItemButton->setText(QApplication::translate("QGCComboBox", "Add Item", 0));
        editRemoveItemButton->setText(QApplication::translate("QGCComboBox", "Delete Item", 0));
        itemValueLabel->setText(QApplication::translate("QGCComboBox", "Value", 0));
#ifndef QT_NO_TOOLTIP
        editSelectParamComboBox->setToolTip(QApplication::translate("QGCComboBox", "Select parameter", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        editSelectParamComboBox->setStatusTip(QApplication::translate("QGCComboBox", "Select parameter", 0));
#endif // QT_NO_STATUSTIP
#ifndef QT_NO_TOOLTIP
        readButton->setToolTip(QApplication::translate("QGCComboBox", "Read the current parameter value on the system", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        readButton->setStatusTip(QApplication::translate("QGCComboBox", "Read the current parameter value on the system", 0));
#endif // QT_NO_STATUSTIP
        readButton->setText(QApplication::translate("QGCComboBox", "Get", 0));
        editDoneButton->setText(QApplication::translate("QGCComboBox", "Done", 0));
#ifndef QT_NO_TOOLTIP
        writeButton->setToolTip(QApplication::translate("QGCComboBox", "Transmit the current slider value to the system", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        writeButton->setStatusTip(QApplication::translate("QGCComboBox", "Transmit the current slider value to the system", 0));
#endif // QT_NO_STATUSTIP
        writeButton->setText(QApplication::translate("QGCComboBox", "Set", 0));
        editInfoCheckBox->setText(QApplication::translate("QGCComboBox", "Show Info", 0));
        editStatusLabel->setText(QApplication::translate("QGCComboBox", "Please click first on refresh to update selection menus..", 0));
        editRefreshParamsButton->setText(QApplication::translate("QGCComboBox", "Refresh", 0));
