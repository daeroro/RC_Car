...
public:
    ...
    {
        PreFlightCalibrationDialog->setWindowTitle(QApplication::translate("PreFlightCalibrationDialog", "Pre-Flight Calibration", 0));
        groupBox->setTitle(QApplication::translate("PreFlightCalibrationDialog", "Generic Vehicle", 0));
    } // retranslateUi
