...
public:
    ...
    {
        LogAnalysis->setWindowTitle(QApplication::translate("LogAnalysis", "Graph", 0));
#ifndef QT_NO_TOOLTIP
        modeDisplayCheckBox->setToolTip(QApplication::translate("LogAnalysis", "<html><head/><body><p>Show mode messages</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
        modeDisplayCheckBox->setText(QApplication::translate("LogAnalysis", "Show MODE", 0));
#ifndef QT_NO_TOOLTIP
        errDisplayCheckBox->setToolTip(QApplication::translate("LogAnalysis", "<html><head/><body><p>Show error messages</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
        errDisplayCheckBox->setText(QApplication::translate("LogAnalysis", "Show ERR", 0));
#ifndef QT_NO_TOOLTIP
        evDisplayCheckBox->setToolTip(QApplication::translate("LogAnalysis", "<html><head/><body><p>Show event messages</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
        evDisplayCheckBox->setText(QApplication::translate("LogAnalysis", "Show EV", 0));
#ifndef QT_NO_TOOLTIP
        msgDisplayCheckBox->setToolTip(QApplication::translate("LogAnalysis", "<html><head/><body><p>Show Info messages</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
        msgDisplayCheckBox->setText(QApplication::translate("LogAnalysis", "Show MSG", 0));
#ifndef QT_NO_TOOLTIP
        showValuesCheckBox->setToolTip(QApplication::translate("LogAnalysis", "<html><head/><body><p>Show value tooltip including the range cursor values when mouse is over plot area.</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
        showValuesCheckBox->setText(QApplication::translate("LogAnalysis", "Show Values Under Mouse", 0));
#ifndef QT_NO_TOOLTIP
        tableCursorCheckBox->setToolTip(QApplication::translate("LogAnalysis", "<html><head/><body><p>Shows a cursor which is linked with the table view. If you select a table line the cursor will jump to this location in the graph and if you drag and drop the cursor the table view will jump to the corresponding line.</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
        tableCursorCheckBox->setText(QApplication::translate("LogAnalysis", "Show Table Cursor", 0));
#ifndef QT_NO_TOOLTIP
        rangeCursorCheckBox->setToolTip(QApplication::translate("LogAnalysis", "<html><head/><body><p>Adds a cursor pair to the plot area. Both of them can be moved by drag an drop. The value tool tip will show additional measurements like min,max... for the area between the cursors.</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
        rangeCursorCheckBox->setText(QApplication::translate("LogAnalysis", "Show Range Cursor", 0));
#ifndef QT_NO_TOOLTIP
        indexTypeCheckBox->setToolTip(QApplication::translate("LogAnalysis", "<html><head/><body><p>switches the horizontal (X) Axis from index to time.</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
        indexTypeCheckBox->setText(QApplication::translate("LogAnalysis", "Use time on x-axis", 0));
#ifndef QT_NO_TOOLTIP
        graphControlsPushButton->setToolTip(QApplication::translate("LogAnalysis", "<html><head/><body><p>Advanced scaling options like setting manual Y-Axis ranges and graph grouping</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
        graphControlsPushButton->setText(QApplication::translate("LogAnalysis", "Advanced Scaling", 0));
#ifndef QT_NO_TOOLTIP
        resetScalingPushButton->setToolTip(QApplication::translate("LogAnalysis", "<html><head/><body><p>Resets all Y-Axis scalings to fit the whole graph</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
        resetScalingPushButton->setText(QApplication::translate("LogAnalysis", "Reset Scaling", 0));
#ifndef QT_NO_TOOLTIP
        storeGraphSettingsButton->setToolTip(QApplication::translate("LogAnalysis", "<html><head/><body><p>Saves the currently enabled graphs with their scaling. The saved view is automagically shared between all open analysis windows.</p><p>Saving a new setting overwrites the old one.</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
        storeGraphSettingsButton->setText(QApplication::translate("LogAnalysis", "Save View", 0));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        applyGraphSettingsButton->setText(QApplication::translate("LogAnalysis", "Apply View", 0));
#ifndef QT_NO_TOOLTIP
        storeToPresetPushBtn->setToolTip(QApplication::translate("LogAnalysis", "<html><head/><body><p>Adds the current enabled graphs with their settings to the Analyzing Presets menue</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
        storeToPresetPushBtn->setText(QApplication::translate("LogAnalysis", "Add View To Preset", 0));
        label->setText(QApplication::translate("LogAnalysis", "<h2>+</h2>", 0));
        label_2->setText(QApplication::translate("LogAnalysis", "<h2>-</h2>", 0));
        tableFilterGroupBox->setTitle(QApplication::translate("LogAnalysis", "Table filter", 0));
        filterAcceptPushButton->setText(QApplication::translate("LogAnalysis", "Accept", 0));
        filterCancelPushButton->setText(QApplication::translate("LogAnalysis", "Cancel", 0));
        filterSelectAllPushButton->setText(QApplication::translate("LogAnalysis", "Select All", 0));
        filterInvertSelectPushButton->setText(QApplication::translate("LogAnalysis", "Invert Select", 0));
