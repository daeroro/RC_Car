...
public:
    ...
    {
        QGCMissionNavLoiterToAlt->setWindowTitle(QApplication::translate("QGCMissionNavLoiterToAlt", "Form", 0));
#ifndef QT_NO_TOOLTIP
        posNSpinBox->setToolTip(QApplication::translate("QGCMissionNavLoiterToAlt", "Position X coordinate", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        posNSpinBox->setStatusTip(QApplication::translate("QGCMissionNavLoiterToAlt", "Position X corrdinate", 0));
#endif // QT_NO_STATUSTIP
        posNSpinBox->setPrefix(QApplication::translate("QGCMissionNavLoiterToAlt", "N ", 0));
        posNSpinBox->setSuffix(QApplication::translate("QGCMissionNavLoiterToAlt", " m", 0));
#ifndef QT_NO_TOOLTIP
        posESpinBox->setToolTip(QApplication::translate("QGCMissionNavLoiterToAlt", "Position Y/Longitude coordinate", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        posESpinBox->setStatusTip(QApplication::translate("QGCMissionNavLoiterToAlt", "Position Y/Longitude coordinate", 0));
#endif // QT_NO_STATUSTIP
        posESpinBox->setPrefix(QApplication::translate("QGCMissionNavLoiterToAlt", "E ", 0));
        posESpinBox->setSuffix(QApplication::translate("QGCMissionNavLoiterToAlt", " m", 0));
#ifndef QT_NO_TOOLTIP
        posDSpinBox->setToolTip(QApplication::translate("QGCMissionNavLoiterToAlt", "Position Z coordinate (local frame, negative)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        posDSpinBox->setStatusTip(QString());
#endif // QT_NO_STATUSTIP
        posDSpinBox->setPrefix(QApplication::translate("QGCMissionNavLoiterToAlt", "D ", 0));
        posDSpinBox->setSuffix(QApplication::translate("QGCMissionNavLoiterToAlt", " m", 0));
#ifndef QT_NO_TOOLTIP
        latSpinBox->setToolTip(QApplication::translate("QGCMissionNavLoiterToAlt", "Latitude in degrees", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        latSpinBox->setStatusTip(QApplication::translate("QGCMissionNavLoiterToAlt", "Latitude in degrees", 0));
#endif // QT_NO_STATUSTIP
        latSpinBox->setPrefix(QApplication::translate("QGCMissionNavLoiterToAlt", "lat ", 0));
        latSpinBox->setSuffix(QApplication::translate("QGCMissionNavLoiterToAlt", "\302\260", 0));
#ifndef QT_NO_TOOLTIP
        lonSpinBox->setToolTip(QApplication::translate("QGCMissionNavLoiterToAlt", "Longitude in degrees", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        lonSpinBox->setStatusTip(QApplication::translate("QGCMissionNavLoiterToAlt", "Longitude in degrees", 0));
#endif // QT_NO_STATUSTIP
        lonSpinBox->setPrefix(QApplication::translate("QGCMissionNavLoiterToAlt", "lon ", 0));
        lonSpinBox->setSuffix(QApplication::translate("QGCMissionNavLoiterToAlt", "\302\260", 0));
#ifndef QT_NO_TOOLTIP
        altSpinBox->setToolTip(QApplication::translate("QGCMissionNavLoiterToAlt", "Altitude in meters", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        altSpinBox->setStatusTip(QApplication::translate("QGCMissionNavLoiterToAlt", "Altitude in meters", 0));
#endif // QT_NO_STATUSTIP
        altSpinBox->setPrefix(QApplication::translate("QGCMissionNavLoiterToAlt", "alt ", 0));
        altSpinBox->setSuffix(QApplication::translate("QGCMissionNavLoiterToAlt", "m", 0));
#ifndef QT_NO_TOOLTIP
        headingreqSpinBox->setToolTip(QApplication::translate("QGCMissionNavLoiterToAlt", "Heading Required , if true (1),  the aircraft will not leave the loiter until heading toward the next waypoint.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        headingreqSpinBox->setStatusTip(QApplication::translate("QGCMissionNavLoiterToAlt", "Heading Required , if true (1),  the aircraft will not leave the loiter until heading toward the next waypoint.", 0));
#endif // QT_NO_STATUSTIP
        headingreqSpinBox->setPrefix(QApplication::translate("QGCMissionNavLoiterToAlt", "hdg:", 0));
        headingreqSpinBox->setSuffix(QApplication::translate("QGCMissionNavLoiterToAlt", " (0/1)", 0));
#ifndef QT_NO_TOOLTIP
        radiusSpinBox->setToolTip(QApplication::translate("QGCMissionNavLoiterToAlt", "Radius in meters. If positive loiter clockwise, negative counter-clockwise, 0 means no change to standard loiter.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        radiusSpinBox->setStatusTip(QApplication::translate("QGCMissionNavLoiterToAlt", "Radius in meters. If positive loiter clockwise, negative counter-clockwise, 0 means no change to standard loiter.", 0));
#endif // QT_NO_STATUSTIP
        radiusSpinBox->setPrefix(QApplication::translate("QGCMissionNavLoiterToAlt", "r:", 0));
        radiusSpinBox->setSuffix(QApplication::translate("QGCMissionNavLoiterToAlt", "m", 0));
    } // retranslateUi
