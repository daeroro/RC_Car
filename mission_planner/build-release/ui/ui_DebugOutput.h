...
public:
    ...
    {
        DebugOutput->setWindowTitle(QApplication::translate("DebugOutput", "Debug Output", 0));
        copyPushButton->setText(QApplication::translate("DebugOutput", "Copy to Clipboard", 0));
        autoScrollCheckBox->setText(QApplication::translate("DebugOutput", "Auto Scroll", 0));
        onTopCheckBox->setText(QApplication::translate("DebugOutput", "Keep Window On Top", 0));
        commitLabel->setText(QApplication::translate("DebugOutput", "Commit:", 0));
        hashLabel->setText(QApplication::translate("DebugOutput", "Hash:", 0));
    } // retranslateUi
