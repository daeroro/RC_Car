...
"}"));
    ...
    void retranslateUi(QWidget *QGCMapToolBar)
    {
        ...
        followPushButton->setToolTip(QApplication::translate("QGCMapToolBar", "Centers map on current vehicle location", 0));
#endif // QT_NO_TOOLTIP
        followPushButton->setText(QApplication::translate("QGCMapToolBar", "Centre on UAV", 0));
