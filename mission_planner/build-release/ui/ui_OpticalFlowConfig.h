...
public:
    ...
    {
        OpticalFlowConfig->setWindowTitle(QApplication::translate("OpticalFlowConfig", "Form", 0));
        label->setText(QApplication::translate("OpticalFlowConfig", "<h2>Optical Flow</h2>", 0));
        enableCheckBox->setText(QApplication::translate("OpticalFlowConfig", "Enable", 0));
