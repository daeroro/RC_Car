...
public:
    ...
    {
        WatchdogProcessView->setWindowTitle(QApplication::translate("WatchdogProcessView", "Form", 0));
        nameLabel->setText(QApplication::translate("WatchdogProcessView", "TextLabel", 0));
        pidLabel->setText(QApplication::translate("WatchdogProcessView", "TextLabel", 0));
        argumentsLabel->setText(QApplication::translate("WatchdogProcessView", "TextLabel", 0));
        startButton->setText(QApplication::translate("WatchdogProcessView", "...", 0));
        restartButton->setText(QApplication::translate("WatchdogProcessView", "...", 0));
    } // retranslateUi
