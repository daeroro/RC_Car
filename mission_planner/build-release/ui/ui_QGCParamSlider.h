...
public:
    ...
    {
        QGCParamSlider->setWindowTitle(QApplication::translate("QGCParamSlider", "Form", 0));
#ifndef QT_NO_TOOLTIP
        editSelectParamComboBox->setToolTip(QApplication::translate("QGCParamSlider", "Select parameter", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        editSelectParamComboBox->setStatusTip(QApplication::translate("QGCParamSlider", "Select parameter", 0));
#endif // QT_NO_STATUSTIP
        editDoneButton->setText(QApplication::translate("QGCParamSlider", "Done", 0));
        editInfoCheckBox->setText(QApplication::translate("QGCParamSlider", "Show Info", 0));
        editRefreshParamsButton->setText(QApplication::translate("QGCParamSlider", "Refresh", 0));
#ifndef QT_NO_TOOLTIP
        readButton->setToolTip(QApplication::translate("QGCParamSlider", "Read the current parameter value on the system", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        readButton->setStatusTip(QApplication::translate("QGCParamSlider", "Read the current parameter value on the system", 0));
#endif // QT_NO_STATUSTIP
        readButton->setText(QApplication::translate("QGCParamSlider", "Get", 0));
#ifndef QT_NO_TOOLTIP
        editSelectComponentComboBox->setToolTip(QApplication::translate("QGCParamSlider", "Select component", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        editSelectComponentComboBox->setStatusTip(QApplication::translate("QGCParamSlider", "Select component", 0));
#endif // QT_NO_STATUSTIP
        editNameLabel->setText(QApplication::translate("QGCParamSlider", "<Parameter Name / Label>", 0));
        editStatusLabel->setText(QApplication::translate("QGCParamSlider", "Please click first on refresh to update selection menus..", 0));
#ifndef QT_NO_TOOLTIP
        writeButton->setToolTip(QApplication::translate("QGCParamSlider", "Transmit the current slider value to the system", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        writeButton->setStatusTip(QApplication::translate("QGCParamSlider", "Transmit the current slider value to the system", 0));
#endif // QT_NO_STATUSTIP
        writeButton->setText(QApplication::translate("QGCParamSlider", "Set", 0));
        editMinSpinBox->setPrefix(QApplication::translate("QGCParamSlider", "MIN: ", 0));
        editMaxSpinBox->setPrefix(QApplication::translate("QGCParamSlider", "MAX: ", 0));
        nameLabel->setText(QApplication::translate("QGCParamSlider", "Name", 0));
        infoLabel->setText(QApplication::translate("QGCParamSlider", "?", 0));
    } // retranslateUi
