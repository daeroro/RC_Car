...
public:
    ...
    {
        QGCPX4FirmwareUpdate->setWindowTitle(QApplication::translate("QGCPX4FirmwareUpdate", "Form", 0));
        selectFileButton->setText(QApplication::translate("QGCPX4FirmwareUpdate", "Select File", 0));
        tabWidget->setTabText(tabWidget->indexOf(firmwareSelectTab), QApplication::translate("QGCPX4FirmwareUpdate", "Firmware", 0));
        settingsStoreButton->setText(QApplication::translate("QGCPX4FirmwareUpdate", "Select File", 0));
        tabWidget->setTabText(tabWidget->indexOf(settingsBackupTab), QApplication::translate("QGCPX4FirmwareUpdate", "Settings", 0));
        fileLabel->setText(QApplication::translate("QGCPX4FirmwareUpdate", "Filename", 0));
        statusLabel->setText(QApplication::translate("QGCPX4FirmwareUpdate", "Status", 0));
        flashButton->setText(QApplication::translate("QGCPX4FirmwareUpdate", "Flash Firmware", 0));
        tabWidget->setTabText(tabWidget->indexOf(flashTab), QApplication::translate("QGCPX4FirmwareUpdate", "Flash Firmware", 0));
        pushButton->setText(QApplication::translate("QGCPX4FirmwareUpdate", "Prev", 0));
        pushButton_2->setText(QApplication::translate("QGCPX4FirmwareUpdate", "Next", 0));
        pushButton_3->setText(QApplication::translate("QGCPX4FirmwareUpdate", "Flash", 0));
    } // retranslateUi
