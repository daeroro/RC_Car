...
public:
    ...
    {
        QGCMissionDoSetCamTriggDist->setWindowTitle(QApplication::translate("QGCMissionDoSetCamTriggDist", "Form", 0));
#ifndef QT_NO_TOOLTIP
        param1SpinBox->setToolTip(QApplication::translate("QGCMissionDoSetCamTriggDist", "Mission parameter #1", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        param1SpinBox->setStatusTip(QApplication::translate("QGCMissionDoSetCamTriggDist", "Mission parameter #1", 0));
#endif // QT_NO_STATUSTIP
        param1SpinBox->setPrefix(QApplication::translate("QGCMissionDoSetCamTriggDist", "Distance ", 0));
        param1SpinBox->setSuffix(QApplication::translate("QGCMissionDoSetCamTriggDist", " (m)", 0));
    } // retranslateUi
