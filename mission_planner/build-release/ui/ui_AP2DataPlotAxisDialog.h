...
public:
    ...
    {
        AP2DataPlotAxisDialog->setWindowTitle(QApplication::translate("AP2DataPlotAxisDialog", "Graph Scale Control", 0));
        label_3->setText(QApplication::translate("AP2DataPlotAxisDialog", "<h1>Axis Range Grouping</h1>\n"
"This Dialog is used for grouping multiple graphs with a single value range (the axis on the left hand side). Select a group from the combo box for a graph, or you can set the range manually by unchecking the \"Auto Axis\" checkbox and typing in Min/Max. <br>Multiple graphs in the same group will all have the same range, which will be automatically calculated", 0));
        applyPushButton->setText(QApplication::translate("AP2DataPlotAxisDialog", "Apply", 0));
        clearPushButton->setText(QApplication::translate("AP2DataPlotAxisDialog", "Clear Scaling", 0));
        cancelPushButton->setText(QApplication::translate("AP2DataPlotAxisDialog", "Done", 0));
    } // retranslateUi
