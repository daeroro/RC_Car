...
""));
    ...
    {
        FrameTypeConfigOld->setWindowTitle(QApplication::translate("FrameTypeConfigOld", "Form", 0));
        plusRadioButton->setText(QApplication::translate("FrameTypeConfigOld", "'Plus' Style", 0));
        pushButton->setText(QString());
        xRadioButton->setText(QApplication::translate("FrameTypeConfigOld", "'X' Style", 0));
        pushButton_2->setText(QString());
        vRadioButton->setText(QApplication::translate("FrameTypeConfigOld", "'V' Style", 0));
        pushButton_5->setText(QString());
        hRadioButton->setText(QApplication::translate("FrameTypeConfigOld", "'H' Style", 0));
        pushButton_3->setText(QApplication::translate("FrameTypeConfigOld", "`", 0));
        label_7->setText(QApplication::translate("FrameTypeConfigOld", "NOTE: X and H are not interchangable as the prop rotation changes", 0));
        newY6radioButton->setText(QApplication::translate("FrameTypeConfigOld", "Y6B", 0));
        pushButton_4->setText(QString());
        label_8->setText(QApplication::translate("FrameTypeConfigOld", "NOTE: This is the new Y6 configuration with all props on the bottom rotating CCW and on top CW ", 0));
    } // retranslateUi
