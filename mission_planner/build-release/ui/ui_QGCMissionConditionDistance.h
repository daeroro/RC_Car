...
public:
    ...
    {
        QGCMissionConditionDistance->setWindowTitle(QApplication::translate("QGCMissionConditionDistance", "Form", 0));
#ifndef QT_NO_TOOLTIP
        param1SpinBox->setToolTip(QApplication::translate("QGCMissionConditionDistance", "Mission parameter #1", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        param1SpinBox->setStatusTip(QApplication::translate("QGCMissionConditionDistance", "Mission parameter #1", 0));
#endif // QT_NO_STATUSTIP
        param1SpinBox->setPrefix(QString());
        param1SpinBox->setSuffix(QApplication::translate("QGCMissionConditionDistance", "m", 0));
    } // retranslateUi
