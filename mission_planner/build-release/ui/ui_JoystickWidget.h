...
public:
    ...
    {
        JoystickWidget->setWindowTitle(QApplication::translate("JoystickWidget", "Dialog", 0));
        groupBox->setTitle(QApplication::translate("JoystickWidget", "Buttons", 0));
        groupBox_2->setTitle(QApplication::translate("JoystickWidget", "Stick", 0));
        label_2->setText(QApplication::translate("JoystickWidget", "Y", 0));
        label->setText(QApplication::translate("JoystickWidget", "X", 0));
        groupBox_3->setTitle(QApplication::translate("JoystickWidget", "Throttle", 0));
        statusLabel->setText(QApplication::translate("JoystickWidget", "hat", 0));
        joystickLabel->setText(QApplication::translate("JoystickWidget", "No joystick detected yet.. waiting", 0));
        joystickButton->setText(QApplication::translate("JoystickWidget", "Activate", 0));
        groupBox_4->setTitle(QApplication::translate("JoystickWidget", "Mappings", 0));
        label_10->setText(QApplication::translate("JoystickWidget", "Invert?", 0));
        pitchInvertCheckBox->setText(QString());
        throttleInvertCheckBox->setText(QString());
        label_7->setText(QApplication::translate("JoystickWidget", "Auto Button", 0));
        label_6->setText(QApplication::translate("JoystickWidget", "Throttle", 0));
        label_5->setText(QApplication::translate("JoystickWidget", "Yaw Axis (Z)", 0));
        label_4->setText(QApplication::translate("JoystickWidget", "Pitch Axis (X)", 0));
        label_3->setText(QApplication::translate("JoystickWidget", "Roll Axis (Y)", 0));
        label_8->setText(QApplication::translate("JoystickWidget", "Stabilize Button", 0));
