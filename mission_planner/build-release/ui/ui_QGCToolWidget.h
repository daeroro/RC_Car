...
public:
    ...
    {
        QGCToolWidget->setWindowTitle(QApplication::translate("QGCToolWidget", "Form", 0));
        hintLabel->setText(QApplication::translate("QGCToolWidget", "Right-click into the widget to customize", 0));
    } // retranslateUi
