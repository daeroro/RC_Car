...
public:
    ...
    {
        commSettings->setWindowTitle(QApplication::translate("commSettings", "Form", 0));
        actionDelete->setText(QApplication::translate("commSettings", "Delete", 0));
#ifndef QT_NO_TOOLTIP
        actionDelete->setToolTip(QApplication::translate("commSettings", "Delete this link", 0));
#endif // QT_NO_TOOLTIP
        actionConnect->setText(QApplication::translate("commSettings", "Connect", 0));
#ifndef QT_NO_TOOLTIP
        actionConnect->setToolTip(QApplication::translate("commSettings", "Connect this link", 0));
#endif // QT_NO_TOOLTIP
        actionClose->setText(QApplication::translate("commSettings", "Close", 0));
#ifndef QT_NO_TOOLTIP
        actionClose->setToolTip(QApplication::translate("commSettings", "Close the configuration window", 0));
#endif // QT_NO_TOOLTIP
        linkGroupBox->setTitle(QApplication::translate("commSettings", "Link", 0));
        advCheckBox->setText(QApplication::translate("commSettings", "Show Advanced Options", 0));
        protocolTypeGroupBox->setTitle(QApplication::translate("commSettings", "GroupBox", 0));
        label->setText(QApplication::translate("commSettings", "Link Type", 0));
        advancedOptionsCheckBox->setText(QApplication::translate("commSettings", "Advanced Options", 0));
        label_5->setText(QApplication::translate("commSettings", "Protocol", 0));
        protocolGroupBox->setTitle(QApplication::translate("commSettings", "Protocol", 0));
        connectButton->setText(QApplication::translate("commSettings", "Connect", 0));
        deleteButton->setText(QApplication::translate("commSettings", "Delete Link", 0));
        closeButton->setText(QApplication::translate("commSettings", "Close", 0));
        connectionStatusLabel->setText(QApplication::translate("commSettings", "Disconnected", 0));
    } // retranslateUi
