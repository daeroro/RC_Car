...
public:
    ...
    {
        AccelCalibrationConfig->setWindowTitle(QApplication::translate("AccelCalibrationConfig", "Form", 0));
        label->setText(QApplication::translate("AccelCalibrationConfig", "<html><head/><body><p><span style=\" font-size:x-large; font-weight:600;\">3D Accelerometer Calibration</span></p></body></html>", 0));
        accelDescLabel->setText(QApplication::translate("AccelCalibrationConfig", "Level your UAV to set default accelerometer offsets (3 axis)<br>This will ask you to place your autopilot on each edge.", 0));
        coutdownLabel->setText(QString());
        outputLabel->setText(QString());
        calibrateAccelButton->setText(QApplication::translate("AccelCalibrationConfig", "Calibrate", 0));
