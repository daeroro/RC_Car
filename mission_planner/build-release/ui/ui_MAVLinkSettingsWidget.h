...
public:
    ...
    void retranslateUi(QWidget *MAVLinkSettingsWidget)
    {
        ...
        loggingCheckBox->setText(QApplication::translate("MAVLinkSettingsWidget", "Log all MAVLink packets", 0));
        ...
        logFileLabel->setText(QApplication::translate("MAVLinkSettingsWidget", "Logfile name", 0));
        logFileButton->setText(QApplication::translate("MAVLinkSettingsWidget", "Select..", 0));
