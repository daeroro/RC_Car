...
public:
    ...
    {
        AP2DataPlot2D->setWindowTitle(QApplication::translate("AP2DataPlot2D", "Graph", 0));
        modeDisplayCheckBox->setText(QApplication::translate("AP2DataPlot2D", "Show MODE", 0));
        label->setText(QApplication::translate("AP2DataPlot2D", "<h1>+</h1>", 0));
        label_2->setText(QApplication::translate("AP2DataPlot2D", "<h1>-</h1>", 0));
        downloadPushButton->setText(QApplication::translate("AP2DataPlot2D", "Download Log", 0));
        loadOfflineLogButton->setText(QApplication::translate("AP2DataPlot2D", "Open Log", 0));
        loadTLogButton->setText(QApplication::translate("AP2DataPlot2D", "Enable Log Playback", 0));
        graphControlsPushButton->setText(QApplication::translate("AP2DataPlot2D", "Graph Controls", 0));
        autoScrollCheckBox->setText(QApplication::translate("AP2DataPlot2D", "Auto Scroll With Data", 0));
        showValuesCheckBox->setText(QApplication::translate("AP2DataPlot2D", "Show Values Under Mouse", 0));
        toKMLPushButton->setText(QApplication::translate("AP2DataPlot2D", "Log to Google Earth File", 0));
    } // retranslateUi
