...
public:
    ...
    {
        QGCCommandButton->setWindowTitle(QApplication::translate("QGCCommandButton", "Form", 0));
        editFinishButton->setText(QApplication::translate("QGCCommandButton", "Done", 0));
        editButtonName->setText(QApplication::translate("QGCCommandButton", "<Button Label>", 0));
        editNameLabel->setText(QApplication::translate("QGCCommandButton", "<Button Description Label (in front of button)>", 0));
        commandButton->setText(QApplication::translate("QGCCommandButton", "Unnamed", 0));
        editComponentSpinBox->setPrefix(QApplication::translate("QGCCommandButton", "Component ID: ", 0));
#ifndef QT_NO_TOOLTIP
        editConfirmationCheckBox->setToolTip(QApplication::translate("QGCCommandButton", "Set the confirm flag for this button. Some commands require that first one command is sent without confirm flag and then a second, equal command with confirm flag. This ensures safety.", 0));
#endif // QT_NO_TOOLTIP
        editConfirmationCheckBox->setText(QApplication::translate("QGCCommandButton", "Set CONFIRM flag", 0));
#ifndef QT_NO_TOOLTIP
        editParam1SpinBox->setToolTip(QApplication::translate("QGCCommandButton", "PARAM1 Value as defined in MAV_CMD list", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        editParam1SpinBox->setStatusTip(QApplication::translate("QGCCommandButton", "PARAM1 Value as defined in MAV_CMD list", 0));
#endif // QT_NO_STATUSTIP
        editParam1SpinBox->setPrefix(QApplication::translate("QGCCommandButton", "P1 ", 0));
#ifndef QT_NO_TOOLTIP
        editParam2SpinBox->setToolTip(QApplication::translate("QGCCommandButton", "PARAM2 Value as defined in MAV_CMD list", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        editParam2SpinBox->setStatusTip(QApplication::translate("QGCCommandButton", "PARAM2 Value as defined in MAV_CMD list", 0));
#endif // QT_NO_STATUSTIP
        editParam2SpinBox->setPrefix(QApplication::translate("QGCCommandButton", "P2: ", 0));
#ifndef QT_NO_TOOLTIP
        editParam3SpinBox->setToolTip(QApplication::translate("QGCCommandButton", "PARAM3 Value as defined in MAV_CMD list", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        editParam3SpinBox->setStatusTip(QApplication::translate("QGCCommandButton", "PARAM3 Value as defined in MAV_CMD list", 0));
#endif // QT_NO_STATUSTIP
        editParam3SpinBox->setPrefix(QApplication::translate("QGCCommandButton", "P3: ", 0));
#ifndef QT_NO_TOOLTIP
        editParam4SpinBox->setToolTip(QApplication::translate("QGCCommandButton", "PARAM4 Value as defined in MAV_CMD list", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        editParam4SpinBox->setStatusTip(QApplication::translate("QGCCommandButton", "PARAM4 Value as defined in MAV_CMD list", 0));
#endif // QT_NO_STATUSTIP
        editParam4SpinBox->setPrefix(QApplication::translate("QGCCommandButton", "P4: ", 0));
        editParam5SpinBox->setPrefix(QApplication::translate("QGCCommandButton", "P5: ", 0));
        editParam6SpinBox->setPrefix(QApplication::translate("QGCCommandButton", "P6: ", 0));
        editParam7SpinBox->setPrefix(QApplication::translate("QGCCommandButton", "P7: ", 0));
        nameLabel->setText(QApplication::translate("QGCCommandButton", "Description", 0));
        editParamsVisibleCheckBox->setText(QApplication::translate("QGCCommandButton", "Keep parameters visible", 0));
    } // retranslateUi
