...
public:
    ...
    {
        QGCSettingsWidget->setWindowTitle(QApplication::translate("QGCSettingsWidget", "Dialog", 0));
        groupBox_2->setTitle(QApplication::translate("QGCSettingsWidget", "Themes", 0));
        outdoorStyle->setText(QApplication::translate("QGCSettingsWidget", "Use outdoor mission style (light background)", 0));
        indoorStyle->setText(QApplication::translate("QGCSettingsWidget", "Use indoor mission style (black background)", 0));
        nativeStyle->setText(QApplication::translate("QGCSettingsWidget", "Use native platform look and feel", 0));
        label_5->setText(QApplication::translate("QGCSettingsWidget", "(Windows/Linux/Mac OS) (Experimental)", 0));
        groupBox->setTitle(QApplication::translate("QGCSettingsWidget", "File Locations", 0));
        label->setText(QApplication::translate("QGCSettingsWidget", "Log output:", 0));
        label_2->setText(QApplication::translate("QGCSettingsWidget", "tlog output:", 0));
        label_3->setText(QApplication::translate("QGCSettingsWidget", "App Data", 0));
        label_13->setText(QApplication::translate("QGCSettingsWidget", "Missions", 0));
        paramDirSetButton->setText(QApplication::translate("QGCSettingsWidget", "Set...", 0));
        mavlinkDirSetButton->setText(QApplication::translate("QGCSettingsWidget", "Set...", 0));
        label_4->setText(QApplication::translate("QGCSettingsWidget", "Parameters", 0));
        appDirSetButton->setText(QApplication::translate("QGCSettingsWidget", "Set...", 0));
        logDirSetButton->setText(QApplication::translate("QGCSettingsWidget", "Set...", 0));
        missionsSetButton->setText(QApplication::translate("QGCSettingsWidget", "Set...", 0));
        audioMuteCheckBox->setText(QApplication::translate("QGCSettingsWidget", "Mute all audio output", 0));
        reconnectCheckBox->setText(QApplication::translate("QGCSettingsWidget", "Automatically reconnect last link on application startup", 0));
#ifndef QT_NO_TOOLTIP
        lowPowerCheckBox->setToolTip(QApplication::translate("QGCSettingsWidget", "Lowers all update rates to save battery power", 0));
#endif // QT_NO_TOOLTIP
        lowPowerCheckBox->setText(QApplication::translate("QGCSettingsWidget", "Enable low power mode", 0));
        titleBarCheckBox->setText(QApplication::translate("QGCSettingsWidget", "Show Docked Widget title bars when NOT in advanced Mode.", 0));
        heartbeatCheckBox->setText(QApplication::translate("QGCSettingsWidget", "Enable GCS Heartbeat transmit (For GCS_Failsafe)", 0));
        mavlinkLoggingCheckBox->setText(QApplication::translate("QGCSettingsWidget", "Enable Mavlink Logging (tlog)", 0));
        enableBetaReleaseCheckBox->setText(QApplication::translate("QGCSettingsWidget", "Enable Beta Release Updates", 0));
#ifndef QT_NO_TOOLTIP
        autoProxyCheckBox->setToolTip(QApplication::translate("QGCSettingsWidget", "Use the system defined network proxies to download data from the Internet through a firewall.", 0));
#endif // QT_NO_TOOLTIP
        autoProxyCheckBox->setText(QApplication::translate("QGCSettingsWidget", "Automatically Use System Network Proxies", 0));
        hideDonateButtonCheckBox->setText(QApplication::translate("QGCSettingsWidget", "Hide Donate Button", 0));
        tabWidget->setTabText(tabWidget->indexOf(general), QApplication::translate("QGCSettingsWidget", "General", 0));
        tabWidget->setTabToolTip(tabWidget->indexOf(general), QApplication::translate("QGCSettingsWidget", "General Settings", 0));
        groupBox_3->setTitle(QApplication::translate("QGCSettingsWidget", "Telemetry Rates (Hz)", 0));
        label_10->setText(QApplication::translate("QGCSettingsWidget", "Sensor", 0));
        label_8->setText(QApplication::translate("QGCSettingsWidget", "Status/Mode", 0));
        label_7->setText(QApplication::translate("QGCSettingsWidget", "Position", 0));
        label_9->setText(QApplication::translate("QGCSettingsWidget", "RC", 0));
        label_6->setText(QApplication::translate("QGCSettingsWidget", "Attitude (Extra1)", 0));
        label_11->setText(QApplication::translate("QGCSettingsWidget", "Extra 2", 0));
        label_12->setText(QApplication::translate("QGCSettingsWidget", "Extra 3", 0));
        tabWidget->setTabText(tabWidget->indexOf(advanced), QApplication::translate("QGCSettingsWidget", "Advanced", 0));
    } // retranslateUi
