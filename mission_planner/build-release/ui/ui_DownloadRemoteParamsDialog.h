...
public:
    ...
    {
        DownloadRemoteParamsDialog->setWindowTitle(QApplication::translate("DownloadRemoteParamsDialog", "Download Parameters", 0));
        statusLabel->setText(QApplication::translate("DownloadRemoteParamsDialog", "Status:", 0));
        downloadButton->setText(QApplication::translate("DownloadRemoteParamsDialog", "Download", 0));
        closeButton->setText(QApplication::translate("DownloadRemoteParamsDialog", "Close", 0));
        refreshButton->setText(QApplication::translate("DownloadRemoteParamsDialog", "Refresh", 0));
    } // retranslateUi
