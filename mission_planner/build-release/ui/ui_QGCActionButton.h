...
public:
    ...
    {
        QGCActionButton->setWindowTitle(QApplication::translate("QGCActionButton", "Form", 0));
        nameLabel->setText(QApplication::translate("QGCActionButton", "Description", 0));
        editActionsRefreshButton->setText(QApplication::translate("QGCActionButton", "Refresh Actions", 0));
        editFinishButton->setText(QApplication::translate("QGCActionButton", "Done", 0));
        editButtonName->setText(QApplication::translate("QGCActionButton", "Button name", 0));
        editNameLabel->setText(QApplication::translate("QGCActionButton", "Description", 0));
        actionButton->setText(QApplication::translate("QGCActionButton", "Button name", 0));
    } // retranslateUi
