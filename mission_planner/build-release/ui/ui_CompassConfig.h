...
public:
    ...
    {
        CompassConfig->setWindowTitle(QApplication::translate("CompassConfig", "Form", 0));
        label->setText(QApplication::translate("CompassConfig", "<h2>Compass</h2>", 0));
        label_4->setText(QApplication::translate("CompassConfig", "<a href=\"http://magnetic-declination.com/\">Declination Website</a>", 0));
        label_3->setText(QApplication::translate("CompassConfig", "Degrees:", 0));
        label_7->setText(QApplication::translate("CompassConfig", "Minutes:", 0));
        label_2->setText(QString());
        enableCheckBox->setText(QApplication::translate("CompassConfig", "Enable", 0));
        autoDecCheckBox->setText(QApplication::translate("CompassConfig", "Auto Declination", 0));
        groupBox->setTitle(QApplication::translate("CompassConfig", "Orientation (ROTATION)", 0));
...
"GPS/Compass", 0));
        ...
        px4Button->setText(QApplication::translate("CompassConfig", "Pixhawk / PX4", 0));
        savedLabel->setText(QString());
        liveCalibrationButton->setText(QApplication::translate("CompassConfig", "Live Calibration", 0));
        label_9->setText(QApplication::translate("CompassConfig", "<a href=\"https://www.youtube.com/watch?v=DmsueBS0J3E\">YouTube Example</a>", 0));
        Examples->setTitle(QApplication::translate("CompassConfig", "Example Manual Settings", 0));
        label_5->setText(QApplication::translate("CompassConfig", "APM with onboard compass: None ie. 0\302\260", 0));
        label_6->setText(QApplication::translate("CompassConfig", "APM with external compass: Roll 180\302\260 ", 0));
        label_8->setText(QApplication::translate("CompassConfig", "PX4/Pixhawk with onboard or \n"
"     external compass: None i.e 0\302\260", 0));
        groupBox_2->setTitle(QApplication::translate("CompassConfig", "Compass Motor Calibration (Optional)", 0));
        compassMotButton->setText(QApplication::translate("CompassConfig", "Compass Motor Calibration", 0));
        label_10->setText(QApplication::translate("CompassConfig", "CompassMot calibrates the compass for magnetic interference created by the power electronics.", 0));
    } // retranslateUi
