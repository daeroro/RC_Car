...
public:
    ...
    {
        AdvancedParamConfig->setWindowTitle(QApplication::translate("AdvancedParamConfig", "Form", 0));
        label->setText(QApplication::translate("AdvancedParamConfig", "<h2>Advanced Params</h2>", 0));
#ifndef QT_NO_TOOLTIP
        searchFilter->setToolTip(QApplication::translate("AdvancedParamConfig", "Type words separated by spaces. Only parameters which match all search terms will be displayed.", 0));
#endif // QT_NO_TOOLTIP
        searchFilter->setPlaceholderText(QApplication::translate("AdvancedParamConfig", "Filter", 0));
    } // retranslateUi
