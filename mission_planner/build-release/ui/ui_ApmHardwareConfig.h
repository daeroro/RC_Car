...
public:
    ...
    {
        ApmHardwareConfig->setWindowTitle(QApplication::translate("ApmHardwareConfig", "Form", 0));
        firmwareButton->setText(QApplication::translate("ApmHardwareConfig", "Install Firmware", 0));
        mandatoryHardware->setText(QApplication::translate("ApmHardwareConfig", "Mandatory Setup ...", 0));
        frameTypeButton->setText(QApplication::translate("ApmHardwareConfig", "Frame Type", 0));
        compassButton->setText(QApplication::translate("ApmHardwareConfig", "Compass", 0));
        accelCalibrateButton->setText(QApplication::translate("ApmHardwareConfig", "Accel Calibration", 0));
        arduPlaneLevelButton->setText(QApplication::translate("ApmHardwareConfig", "ArduPlane Level", 0));
        radioCalibrateButton->setText(QApplication::translate("ApmHardwareConfig", "Radio Calibration", 0));
        flightModesButton->setText(QApplication::translate("ApmHardwareConfig", "Flight Modes", 0));
        failSafeButton->setText(QApplication::translate("ApmHardwareConfig", "Failsafe", 0));
        optionalHardwareButton->setText(QApplication::translate("ApmHardwareConfig", "Optional Setup ...", 0));
        batteryMonitorButton->setText(QApplication::translate("ApmHardwareConfig", "Battery Monitor", 0));
        rangeFinderButton->setText(QApplication::translate("ApmHardwareConfig", "Range Finder", 0));
        airspeedButton->setText(QApplication::translate("ApmHardwareConfig", "Airspeed", 0));
        opticalFlowButton->setText(QApplication::translate("ApmHardwareConfig", "Optical Flow", 0));
        osdButton->setText(QApplication::translate("ApmHardwareConfig", "OSD", 0));
        cameraGimbalButton->setText(QApplication::translate("ApmHardwareConfig", "Camera Gimbal", 0));
        antennaTrackerButton->setText(QApplication::translate("ApmHardwareConfig", "Antenna Tracker", 0));
        radio3DRLargeButton->setText(QApplication::translate("ApmHardwareConfig", "3DR Radio", 0));
        antennaTrackerLargeButton->setText(QApplication::translate("ApmHardwareConfig", "Antenna Tracker", 0));
        hiddenPushButton->setText(QApplication::translate("ApmHardwareConfig", "hidden", 0));
        globalParamStateLabel->setText(QApplication::translate("ApmHardwareConfig", "Parameters Downloaded", 0));
        globalParamProgressLabel->setText(QApplication::translate("ApmHardwareConfig", "0/?", 0));
    } // retranslateUi
