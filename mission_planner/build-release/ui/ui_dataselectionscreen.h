...
public:
    ...
    {
        DataSelectionScreen->setWindowTitle(QApplication::translate("DataSelectionScreen", "Form", 0));
        clearPushButton->setText(QApplication::translate("DataSelectionScreen", "Clear Selection", 0));
    } // retranslateUi
