...
public:
    ...
    {
        ParamCompareDialog->setWindowTitle(QApplication::translate("ParamCompareDialog", "Compare Parameters", 0));
        loadButton->setText(QApplication::translate("ParamCompareDialog", "Load File", 0));
        continueButton->setText(QApplication::translate("ParamCompareDialog", "Continue", 0));
        cancelButton->setText(QApplication::translate("ParamCompareDialog", "Cancel", 0));
        checkAllBox->setText(QApplication::translate("ParamCompareDialog", "Check/Uncheck All", 0));
    } // retranslateUi
