...
public:
    ...
    {
        QGCUDPClientLinkConfiguration->setWindowTitle(QApplication::translate("QGCUDPClientLinkConfiguration", "Form", 0));
        label->setText(QApplication::translate("QGCUDPClientLinkConfiguration", "Address", 0));
        portLabel->setText(QApplication::translate("QGCUDPClientLinkConfiguration", "Port", 0));
    } // retranslateUi
