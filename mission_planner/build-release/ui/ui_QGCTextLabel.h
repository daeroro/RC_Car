...
public:
    ...
    {
        QGCTextLabel->setWindowTitle(QApplication::translate("QGCTextLabel", "Form", 0));
        editNameLabel->setText(QApplication::translate("QGCTextLabel", "<Label Description Label (in front of text)>", 0));
        nameLabel->setText(QApplication::translate("QGCTextLabel", "Description", 0));
        editTextParam->setText(QApplication::translate("QGCTextLabel", "<Text Param>", 0));
        editFinishButton->setText(QApplication::translate("QGCTextLabel", "Done", 0));
        editComponentSpinBox->setPrefix(QApplication::translate("QGCTextLabel", "Component ID: ", 0));
        textLabel->setText(QApplication::translate("QGCTextLabel", "TextLabel", 0));
    } // retranslateUi
