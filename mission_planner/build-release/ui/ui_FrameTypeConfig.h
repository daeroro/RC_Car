...
public:
    ...
    {
        FrameTypeConfig->setWindowTitle(QApplication::translate("FrameTypeConfig", "Form", 0));
        label->setText(QApplication::translate("FrameTypeConfig", "<h2>Frame Setup</h2>", 0));
        LoadParametersButton->setText(QApplication::translate("FrameTypeConfig", "Load Parameters for \n"
"Common Frame Types", 0));
    } // retranslateUi
