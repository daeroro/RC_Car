...
""));
    ...
    {
        UASActionsWidget->setWindowTitle(QApplication::translate("UASActionsWidget", "Form", 0));
        missionGroupBox->setTitle(QApplication::translate("UASActionsWidget", "Mission Controls", 0));
        restartMissionButton->setText(QApplication::translate("UASActionsWidget", "Restart Mission", 0));
        changeAltitudeButton->setText(QApplication::translate("UASActionsWidget", "Change Altitude", 0));
        changeSpeedButton->setText(QApplication::translate("UASActionsWidget", "Change Speed", 0));
        goToWaypointButton->setText(QApplication::translate("UASActionsWidget", "Go To Waypoint", 0));
        currentWaypointLabel->setText(QApplication::translate("UASActionsWidget", "Current WP:", 0));
        actionsGroupBox->setTitle(QApplication::translate("UASActionsWidget", "Actions", 0));
        armDisarmButton->setText(QApplication::translate("UASActionsWidget", "ARM", 0));
        setModeButton->setText(QApplication::translate("UASActionsWidget", "Set Mode", 0));
        exeActionButton->setText(QApplication::translate("UASActionsWidget", "Execute Action", 0));
        armedStatuslabel->setText(QApplication::translate("UASActionsWidget", "<html><head/><body><p><span style=\" color:#ff0000;\">disconnected</span></p></body></html>", 0));
        shortcutGroupBox->setTitle(QApplication::translate("UASActionsWidget", "Shortcut Modes", 0));
        autoModeButton->setText(QApplication::translate("UASActionsWidget", "Auto", 0));
        stabilizeModeButton->setText(QApplication::translate("UASActionsWidget", "Stabilize", 0));
        stabilizeModeButton->setShortcut(QApplication::translate("UASActionsWidget", "Meta+Shift+S", 0));
        loiterModeButton->setText(QApplication::translate("UASActionsWidget", "Loiter", 0));
        loiterModeButton->setShortcut(QApplication::translate("UASActionsWidget", "Meta+Shift+L", 0));
        rtlModeButton->setText(QApplication::translate("UASActionsWidget", "RTL", 0));
        rtlModeButton->setShortcut(QApplication::translate("UASActionsWidget", "Meta+Shift+R", 0));
        opt1ModeButton->setText(QApplication::translate("UASActionsWidget", "...", 0));
        opt2ModeButton->setText(QApplication::translate("UASActionsWidget", "...", 0));
        opt3ModeButton->setText(QApplication::translate("UASActionsWidget", "...", 0));
        opt4ModeButton->setText(QApplication::translate("UASActionsWidget", "...", 0));
    } // retranslateUi
