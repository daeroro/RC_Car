...
public:
    ...
    {
        TerminalConsole->setWindowTitle(QApplication::translate("TerminalConsole", "Form", 0));
        terminalGroupBox->setTitle(QApplication::translate("TerminalConsole", "Terminal Output", 0));
        connectButton->setText(QApplication::translate("TerminalConsole", "Connect", 0));
        disconnectButton->setText(QApplication::translate("TerminalConsole", "Disconnect", 0));
        localEchoCheckBox->setText(QApplication::translate("TerminalConsole", "Local Echo", 0));
        logsButton->setText(QApplication::translate("TerminalConsole", "Logs", 0));
        settingsButton->setText(QApplication::translate("TerminalConsole", "Adv. Settings", 0));
        clearButton->setText(QApplication::translate("TerminalConsole", "Clear", 0));
    } // retranslateUi
