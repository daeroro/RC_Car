...
public:
    ...
    {
        AntennaTrackerConfig->setWindowTitle(QApplication::translate("AntennaTrackerConfig", "Form", 0));
        label->setText(QApplication::translate("AntennaTrackerConfig", "<h2>Antenna Tracker</h2>", 0));
        label_2->setText(QApplication::translate("AntennaTrackerConfig", "Interface", 0));
        connectPushButton->setText(QApplication::translate("AntennaTrackerConfig", "Connect", 0));
        groupBox->setTitle(QApplication::translate("AntennaTrackerConfig", "Pan", 0));
        label_3->setText(QApplication::translate("AntennaTrackerConfig", "Angle", 0));
        label_4->setText(QApplication::translate("AntennaTrackerConfig", "PWM", 0));
        label_5->setText(QApplication::translate("AntennaTrackerConfig", "Center PWM", 0));
        label_7->setText(QApplication::translate("AntennaTrackerConfig", "Trim", 0));
        panTrimLabel->setText(QApplication::translate("AntennaTrackerConfig", "0", 0));
        panRevCheckBox->setText(QApplication::translate("AntennaTrackerConfig", "Rev", 0));
        groupBox_2->setTitle(QApplication::translate("AntennaTrackerConfig", "Tilt", 0));
        label_8->setText(QApplication::translate("AntennaTrackerConfig", "Angle", 0));
        label_9->setText(QApplication::translate("AntennaTrackerConfig", "PWM", 0));
        label_10->setText(QApplication::translate("AntennaTrackerConfig", "Center PWM", 0));
        label_11->setText(QApplication::translate("AntennaTrackerConfig", "Trim", 0));
        tiltTrimLabel->setText(QApplication::translate("AntennaTrackerConfig", "0", 0));
        tiltRevCheckBox->setText(QApplication::translate("AntennaTrackerConfig", "Rev", 0));
    } // retranslateUi
